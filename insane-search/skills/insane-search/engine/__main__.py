...
def main(argv: list[str] | None = None) -> int:
    # Windows consoles default stdout/stderr to the system codepage (e.g. cp949),
    # which can't encode emoji/box-drawing characters in our own output and
    # crashes with UnicodeEncodeError. Force UTF-8 regardless of locale.
